        ...
        <div class="modal-section git-metadata-section">
            <div class="git-metadata-header">
                <div class="git-metadata-dates">
                    ${metadata.created ? `<span class="git-metadata-date"><strong>Created:</strong> ${createdDate}</span>` : ''}
                    ${metadata.lastUpdated ? `<span class="git-metadata-date"><strong>Last Updated:</strong> ${updatedDate}</span>` : ''}
                </div>
                ${githubFileUrl ? `
